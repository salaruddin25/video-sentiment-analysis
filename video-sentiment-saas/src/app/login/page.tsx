  ...
  async function onSubmit(data: LoginSchema) {
    try{
        ...
        if(!signInResults?.error){
            ...
            setError(signInResults.error === "CredentialsSignin" 
            ...
            <main className="flex h-[calc(100vh-4rem)] items-center justify-center">
                <div className="w-full max-w-md space-y-8 px-4">
                    ...
                    <form className="mt-8 space-y-6"
                     ...
                     >
                        {error && (<div className="rounded-md bg-red-50 p-4 text-red-500">
                            {error}
                            </div>
                        )}
                        ...
                        <div className="space-y-4">
                                ...
                                <input {...form.register("email")}
                                 ...
                                 className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm placehoolder-gray-400 shadow-sm focus:border-gray-500 focus:outline:none"
                                  />
                                {
                        ...
                        <button type="submit" disabled={loading} className="flex w-full justify-center rounded-md bg-gray-800 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:opacity-50"
                        >
